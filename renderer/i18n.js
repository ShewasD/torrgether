const en = {
  ...
  'home.kicker': 'Start together',
  'home.title': 'Find something to watch',
  'home.subtitle': 'Join a room, search the catalog, or import a torrent before opening the clean Watch screen.',
  'home.roomTitle': 'Room',
  'home.roomSubtitle': 'Create or join a room before importing media.',
  'home.importTitle': 'Import source',
  'home.importHint': 'Catalog imports appear here. Manual torrent import is also available on Watch.',
  'watch.kicker': 'Watch room',
  'watch.title': 'Playback',
  'watch.importTitle': 'Torrent import',
  'watch.importSubtitle': 'Host chooses the torrent and selected video for the room.',
  'watch.clientImportHint': 'Clients receive the host selection automatically.',
  'watch.selectedFile': 'Selected file',
  'watch.buffering': 'Playback state',
  'watch.emptyState': 'Choose a torrent to start watching.',
  'watch.loadingState': 'Loading torrent...',
  'watch.readyState': 'Ready to watch',
  'watch.bufferingState': 'Buffering',
  'watch.playingState': 'Playing',
  'watch.pausedState': 'Paused',
  'watch.launchingState': 'Starting player...',
  'watch.playerFallbackState': 'Using built-in player fallback',
  'watch.playerErrorState': 'Player error',
  'watch.playerIdle': 'Player idle',
  'watch.playerMissing': 'MPV missing',
  'watch.playerExternal': 'MPV player',
  'watch.playerEmbedded': 'Built-in player',
  'settings.general': 'General',
  'settings.room': 'Room and server',
  'settings.advancedImport': 'Advanced import',
  'settings.developer': 'Developer and logs',
  ...
  'participants.count': '{count} members',
  ...
  'player.advancedHint': 'Advanced controls and diagnostics are managed here.',
  'catalog.all': 'All',
